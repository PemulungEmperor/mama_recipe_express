...
const { getUsers, registerUser, updateUser, deleteUser, login, logout, updateUserImage, deleteUserImage, updateProfile, updateUsername, nativeUserImage } = require("../controller/user.controller");
...
// update native profile image
router.put("/native-update-image/:id", nativeUserImage);
